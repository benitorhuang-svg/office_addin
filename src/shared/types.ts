 ...
 */
import { NexusPowerState, NexusProvider, SocketEvent } from "@shared/enums";
...
export interface SocketEventMap {
  [SocketEvent.SYSTEM_STATE_UPDATED]: {
    power?: NexusPowerState;
    provider?: NexusProvider;
    status?: string;
    isStreaming?: boolean;
  };
  [SocketEvent.CHAT_PROGRESS]: {
    text?: string;
    done?: boolean;
    progress?: number;
    status?: string;
  ...
  [SocketEvent.EXCEL_CHART_EXTERNAL]: {
    title: string;
    chartType: string;
    range: string;
    index?: number;
