import type { WritingPreset } from "@shared/atoms/ai-core/types.js";
...
export const FALLBACK_PRESETS: WritingPreset[] = [
  {
    ...
    system:
      "Answer the user's request directly and clearly. Be concise by default. Do not add appendices, sample code, PoC snippets, speculative parameters, or extra scenarios unless the user explicitly asks for them.",
  },
  {
    id: "meeting-notes",
    label: "會議紀錄",
