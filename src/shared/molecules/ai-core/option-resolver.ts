...
import type { AzureInfo, ACPConnectionMethod, ACPSessionConfig, ACPOptions } from '@shared/atoms/ai-core/types.js';

// Atomized Option Builders
import { buildCopilotCliOptions } from '@shared/molecules/ai-core/options/copilot-cli-options.js';
import { buildGeminiCliOptions } from '@shared/molecules/ai-core/options/gemini-cli-options.js';
import { buildAzureByokOptions } from '@shared/molecules/ai-core/options/azure-byok-options.js';
import { buildRemoteCliOptions } from '@shared/molecules/ai-core/options/remote-cli-options.js';
