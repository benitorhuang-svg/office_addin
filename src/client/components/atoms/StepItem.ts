    ...
    children: [
      ...
      (() => {
        ...
        if (isDone) {
          ...
          pulse.className =
            "nexus-absolute nexus-inset-0 nexus-rounded-full nexus-bg-blue-500 nexus-animate-pulse-blue";
          shell.appendChild(pulse);

          const core = document.createElement("div");
          core.className =
            "nexus-relative nexus-w-2.5 nexus-h-2.5 nexus-bg-blue-600 nexus-rounded-full nexus-m-1 nexus-border nexus-border-white";
      ...
      (() => {
        ...
        const labelText = step.title.includes("：") ? step.title.split("：")[0] || "任務" : "任務";
        const titleText = step.title.includes("：")
        ...
        if (step.description) {
          ...
          if (isActive) {
            ...
            shimmer.className =
              "nexus-absolute nexus-inset-0 nexus-pointer-events-none nexus-animate-shimmer-fast nexus-opacity-20";
