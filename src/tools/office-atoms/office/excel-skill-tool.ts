...
import { ExcelSkillInvoker, excelSkill } from "@agents/expert-excel/index.js";
import {
  ...
  return createOfficeSkillTool(
    {
      name: "excel_skill",
      description:
        "Provide the project Excel expert skill so the agent can reason about tables, formulas, pivots, and chart-ready analysis.",
      domain: "excel",
