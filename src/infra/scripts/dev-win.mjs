...
const skillsBridgeDir = path.join(repoRoot, 'src', 'agents', 'skills');
const python = process.platform === 'win32' ? 'python' : 'python3';
startProcess(python, ['-m', 'uvicorn', 'skill_bridge:app', '--host', '127.0.0.1', '--port', skillBridgePort, '--app-dir', skillsBridgeDir], 'skill-bridge');
